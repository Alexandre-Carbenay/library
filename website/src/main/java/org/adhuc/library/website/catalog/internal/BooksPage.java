...
public class BooksPage extends NavigablePageImpl<Book> {
    ...
    public BooksPage(@JsonProperty("page") PageAttributes page,
        ...
        super(embedded.convertedEditions(), PageRequest.of(page.number(), page.size()), page.totalElements(), links.converted());
    }
    ...
    public record EmbeddedValues(List<BookDto> editions, List<AuthorDto> authors) {
        List<Book> convertedEditions() {

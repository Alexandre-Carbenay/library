...
class ArchitectureTests {
    ...
    private static final String AUTHORS_PACKAGE = "org.adhuc.library.catalog.authors";
    private static final String BOOKS_PACKAGE = "org.adhuc.library.catalog.books";
    private static final String EDITIONS_PACKAGE = "org.adhuc.library.catalog.editions";

    @ArchTest
    ArchRule onion = JMoleculesArchitectureRules.ensureOnionClassical();

    @ArchTest
    ArchRule noCycles = slices().matching("org.adhuc.library.catalog.(*)..").should().beFreeOfCycles();

...
public final class EditionsMother {
    ...
    public static Arbitrary<Edition> notableEditionsOf(UUID authorId) {
        return Combinators.combine(
                ...
                Editions.titles(),
                Editions.publicationDates(),
                Editions.authoredWith(authorId),
                Editions.languages(),
                Editions.summaries()
        ).as(Edition::new);
    }
    ...
    public static class EditionBuilder {
        ...
        public EditionBuilder isbn(String isbn) {
            edition = new Edition(isbn, edition.title(), edition.publicationDate(), edition.authors(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder title(String title) {
            edition = new Edition(edition.isbn(), title, edition.publicationDate(), edition.authors(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder publicationDate(PublicationDate publicationDate) {
            edition = new Edition(edition.isbn(), edition.title(), publicationDate, edition.authors(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder authors(Set<Author> authors) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), authors, edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder language(String language) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), edition.authors(), language, edition.summary());
            return this;
        }

        public EditionBuilder summary(String summary) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), edition.authors(), edition.language(), summary);
            return this;
        }

...
public final class EditionsMother {
    ...
    public static class EditionBuilder {
        ...
        public EditionBuilder isbn(String isbn) {
            edition = new Edition(isbn, edition.title(), edition.publicationDate(), edition.book(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder title(String title) {
            edition = new Edition(edition.isbn(), title, edition.publicationDate(), edition.book(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder publicationDate(PublicationDate publicationDate) {
            edition = new Edition(edition.isbn(), edition.title(), publicationDate, edition.book(), edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder book(Book book) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), book, edition.language(), edition.summary());
            return this;
        }

        public EditionBuilder language(String language) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), edition.book(), language, edition.summary());
            return this;
        }

        public EditionBuilder summary(String summary) {
            edition = new Edition(edition.isbn(), edition.title(), edition.publicationDate(), edition.book(), edition.language(), summary);
            return this;
        }

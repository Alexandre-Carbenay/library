...
class AutoLoadedBooksMother {

    static final Book L_ETRANGER = new Book(
            "9782070360024",
            "L'étranger",
    ...
    static final Book LA_PESTE = new Book(
            "9782070360420",
            "La peste",
    ...
    static final Book LA_CHUTE = new Book(
            "9782070360109",
            "La chute",
    ...
    static final Book MADAME_BOVARY = new Book(
            "9782070413119",
            "Madame Bovary",
    ...
    static final Book SALAMMBO = new Book(
            "9782070308781",
            "Salammbô",
    ...
    static final Book ANNA_KARENINE = new Book(
            "9782253098386",
            "Anna Karénine",
    ...
    static final Book LA_GUERRE_ET_LA_PAIX_1 = new Book(
            "9782070425174",
    ...
    static final Book LA_GUERRE_ET_LA_PAIX_2 = new Book(
            "9782070425181",
    ...
    static final Book LES_COSAQUES = new Book(
            "9782070368501",
            "Les cosaques",
    ...
    static final Book CHER_CONNARD = new Book(
            "9782253079699",
            "Cher connard",
    ...
    static final Book BAISE_MOI = new Book(
            "9782253087557",
            "Baise moi",
    ...
    static final Book APOCALYPSE_BEBE = new Book(
            "9782253159711",
            "Apocalypse bébé",

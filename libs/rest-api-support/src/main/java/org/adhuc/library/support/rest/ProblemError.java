 ...
 * </code></pre>
 */
public sealed interface ProblemError permits ProblemError.DefaultError, ProblemError.ParameterError, ProblemError.PointerError {
    /**
     * A default error, that contains only a detail.
     */
    record DefaultError(String detail) implements ProblemError {
